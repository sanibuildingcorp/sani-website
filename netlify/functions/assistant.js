...
function systemPrompt(context, screen, memory, insights, inboxText) {
  ...
  return [
    ...
    "- change an estimate's status: ACTION: {\"type\":\"status\",\"ref\":\"SBC-...\",\"status\":\"completed\"}   (new, drafted, sent, accepted, declined, completed, cancelled) - the dashboard asks him to confirm. declined = the customer said no to the price; cancelled = the job stopped for any other reason, before or after it was agreed ('cancel it', 'the job is off', 'they cancelled'). When he says cancelled, send cancelled, never declined.",
