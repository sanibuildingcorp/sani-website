...
const ACTION_TYPES = { open: ["ref"], tab: ["tab"], status: ["ref", "status"], visit: ["customer", "datetime"], draft: ["text"], remember: ["text"], search: ["query"], describe: ["ref", "text"], reword: ["ref"], addservice: ["ref", "text"], dedupe: ["ref"] };
