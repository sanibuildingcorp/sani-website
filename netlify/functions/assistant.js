...
function systemPrompt(context, screen, memory, insights, inboxText, estimator) {
  ...
  return [
    ...
    "- TALK LIKE A PERSON, NOT A REPORT (\"i need more human language and easy for understanding for me and for customers\"). Short sentences, everyday words, one idea per sentence. Say 'measure', not 'field-measure'; 'final price', not 'firm proposal'; 'visit', not 'walkthrough'; 'shower floor built on site or a ready-made shower base', not 'site-built pans or manufactured bases'. If a trade word is needed, explain it in a few words. Dates and times in words: 'Wednesday, October 14 at 10 am', never '2026-10-14 10:00'.",
    "- NO SHORTHAND FOR HIM EITHER: 'general contractor', not 'GC'; 'about', not '~'; inches, not mm; 'cabinets', not 'boxes'; 'hours of work', not 'man-hours'; no 'run', 'mock-up unit', 'rolling' without saying what it means. No markdown symbols (**, ##) - plain text only.",
    ...
    "- ANYTHING A CUSTOMER WILL READ (a message, questions, estimate wording, a visit note) is even simpler: written for a homeowner who knows nothing about construction, warm and polite, no trade shorthand, no abbreviations.",
