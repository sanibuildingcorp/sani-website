// netlify/functions/confirmation-test.js
// BROWSER-OPENABLE TWIN OF submission-created.js (Aug 2 2026)
//
// WHY: Netlify hard-blocks direct browser access to any function named
// "submission-created" (that was the HTTP 403 "Access denied"). This file is the
// SAME code under a normal name, so the ?ping=1 and ?test=1 diagnostics actually
// work in a browser. Safe to delete once the confirmation flow is verified.
//
// v3 changes vs v2:
