...
ok('ON A PHONE THE HERO IS THE MARBLE BATHROOM HE CHOSE (portrait, dark wall behind the white words), preloaded for phones only; computers keep the room, preloaded for computers only', /<picture><source media="\(max-width: 899px\)" srcset="images\/hero\/home-hero-bath\.webp\?v=\d+" width="657" height="986"><img class="hero-img"/.test(IDX) && /<link rel="preload" as="image" href="images\/hero\/home-hero-bath\.webp\?v=\d+" media="\(max-width: 899px\)" fetchpriority="high">/.test(IDX) && fs.statSync(path.join(ROOT, 'images/hero/home-hero-bath.webp')).size < 120 * 1024 && /<link rel="preload" as="image" href="images\/hero\/home-hero-room\.webp\?v=\d+" media="\(min-width: 900px\)" fetchpriority="high">/.test(IDX));
