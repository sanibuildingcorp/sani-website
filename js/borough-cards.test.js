...
ok('each card: photos that slide, the mark, the rating, badges, a quote box, neighborhoods, and two buttons', cards.every((c) => (c.match(/<img /g) || []).length >= 3 && /class="bc-mark"/.test(c) && /<b>4\.9<\/b><span>\(67 Google reviews\)<\/span>/.test(c) && /Fully insured/.test(c) && /class="bc-quote/.test(c) && /<b>Serving<\/b>/.test(c) && /class="bc-cta" href="\/estimate"/.test(c) && /class="bc-more" href="\/[a-z-]+"/.test(c)));
