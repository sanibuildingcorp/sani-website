...
ok('...on a phone the photo comes first, above the words, at 4:3', /@media\(max-width:899px\)\{[^}]*\}[^}]*\.page-hero-bg-blur\{position:relative!important;inset:auto!important;width:calc\(100% - 28px\)!important;margin:0 auto!important;aspect-ratio:4\/3\}/.test(CSS));
